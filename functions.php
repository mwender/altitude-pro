...
//* Include functions
include_once( get_stylesheet_directory() . '/lib/fns/blog.php' );
include_once( get_stylesheet_directory() . '/lib/fns/constants.php' );
include_once( get_stylesheet_directory() . '/lib/fns/google-analytics.php' );
include_once( get_stylesheet_directory() . '/lib/fns/layouts.php' );
